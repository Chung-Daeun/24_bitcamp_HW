                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">작성일:
                                ...
                                <fmt:parseDate value="${notice.regdate}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedRegdate" type="both"></fmt:parseDate>
                                <!--fmt:formatDateDate타입의 날짜를 형식 지정에 맞게 표출-->
                                <fmt:formatDate value="${parsedRegdate}" pattern="yyyy-MM-dd"></fmt:formatDate>
                            </p>
                            <a href="/board/notice-detail.do?id=${notice.id}&cnt=${notice.cnt}" class="btn btn-outline-secondary btn-sm">자세히 보기</a>
                        </div>
                    </div>
                </c:forEach>
            </div>
